...
namespace BE
{
    public class Usuario
    {
        ...
        public Usuario(int id, string dni, string nombre, string apellido, string telefono, string mail, string contraseña, DateTime fechaNacimiento, string id_familia, string salt, string idioma)
        {
            this.id_usuario = id;
            this.dni = dni;
            this.nombre = nombre;
